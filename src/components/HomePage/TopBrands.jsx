  ...
  return (
    <section className="space-y-6 mb-15">
      <div className="text-neutral-800 text-center">
        ...
        <p>Explore top brands that keep you cool, stylish, and protected all summer long.</p>
      </div>

      <div className="grid grid-cols-4 gap-6">
        <div 
          className="h-50 shadow-lg rounded-xl flex items-center justify-center transition duration-300 hover:-translate-y-2 bg-base-100"
        >
